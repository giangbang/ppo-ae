...
if __name__ == "__main__":
    ...
    """ Measure the counts of each state in MiniGrid """
    minigrid_count = MiniGridCount(envs)
    ...
    for update in range(1, num_updates + 1):
        ...
        for step in range(0, args.num_steps):
            ...
            if global_step > args.ae_warmup_steps:
                ...
                """ Modulate episodic intrinsic reward with global visit count """
                intrinsic_reward /= torch.Tensor(minigrid_count.get_cnt()).to(device).view(intrinsic_reward.shape)+1e-8
